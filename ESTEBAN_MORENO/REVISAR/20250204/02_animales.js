...
miAPI.get('/datos/:id', (req, res) => {
    ...
    let candidato=animales.find(item => item.codigo==codigo);
    if (candidato) {
        console.log('Encontrado animal:', candidato);
...
miAPI.post('/datos', (req, res) => {
    ...
    if ('nombre' in detalles && 'patas' in detalles) {
        ...
        let nuevo={codigo:n, nombre:detalles.nombre, patas:detalles.patas};
...
miAPI.put('/datos/:id', (req, res) => {
    ...
    if (candidato) {
        ...
        if ('patas' in detalles && detalles.patas!=candidato.patas) {
            candidato.patas=detalles.patas;
            cambiado=true;
        }
        if (cambiado)
